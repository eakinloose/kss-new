...
describe("GET /users - JSONPlaceholder API", () => {
  ...
  it("should return 10 users with valid structure", async () => {
    ...
    expect(users).to.be.an("array").with.lengthOf(10);
    ...
    expect(user.company).to.include.all.keys("name", "catchPhrase", "bs");

    // Optional: Check a few specific values
